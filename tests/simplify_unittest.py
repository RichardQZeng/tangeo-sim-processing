...
class Test(unittest.TestCase):
    ...
    def test_case08(self):
        ...
        qgs_geom0 = create_line([(0, 0), (5, 3), (10, 4), (15, 3), (20, 0)])
        qgs_feature_out = build_and_launch(title, [qgs_geom0], 0.1)
    ...
    def test_case15(self):
        ...
        out_qgs_geom0 = create_line(
            [(0, 0), (5, 2), (50, 0), (50, -5), (7, -5), (7, 1)]
        )
        val0 = out_qgs_geom0.equals(qgs_feature_out[0])
        self.assertTrue(val0, title)
    ...
    def test_case19(self):
        ...
        qgs_geom1 = create_line([(2, -1), (2, 0.5)])
        qgs_feature_out = build_and_launch(title, [qgs_geom0, qgs_geom1], 3)
        out_qgs_geom0 = create_line([(0, 0), (2, 2), (8, 0)])
        out_qgs_geom1 = create_line([(2, -1), (2, 0.5)])
        val0 = out_qgs_geom0.equals(qgs_feature_out[0])
        val1 = out_qgs_geom1.equals(qgs_feature_out[1])
        self.assertTrue(val0 and val1, title)
    ...
    def test_case20(self):
        ...
        qgs_geom1 = create_line([(6, -1), (6, 0.5)])
        qgs_feature_out = build_and_launch(title, [qgs_geom0, qgs_geom1], 3)
        out_qgs_geom0 = create_line([(0, 0), (6, 2.5), (8, 0)])
        out_qgs_geom1 = create_line([(6, -1), (6, 0.5)])
        val0 = out_qgs_geom0.equals(qgs_feature_out[0])
        val1 = out_qgs_geom1.equals(qgs_feature_out[1])
        self.assertTrue(val0 and val1, title)
    ...
    def test_case21(self):
        ...
        qgs_geom0 = create_line([(0, 0), (2, 2), (4, 0)])
        qgs_geom1 = create_line([(2, 0.1), (2, 0.2)])
        qgs_feature_out = build_and_launch(title, [qgs_geom0, qgs_geom1], 3)
        out_qgs_geom0 = create_line([(0, 0), (2, 2), (4, 0)])
        out_qgs_geom1 = create_line([(2, 0.1), (2, 0.2)])
        val0 = out_qgs_geom0.equals(qgs_feature_out[0])
        val1 = out_qgs_geom1.equals(qgs_feature_out[1])
        self.assertTrue(val0 and val1, title)
    ...
    def test_validate_structure_flag_disabled(self):
        ...
        rb_results = Simplify.douglas_peucker([qgs_feature], 3, False, feedback)
    ...
    def test_validate_structure_flag_enabled(self):
        ...
        rb_results = Simplify.douglas_peucker([qgs_feature], 3, True, feedback)
