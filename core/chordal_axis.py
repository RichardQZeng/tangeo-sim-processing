...
from qgis.core import (QgsFeature, QgsProcessingException, QgsWkbTypes, QgsGeometry, QgsPoint,
                       QgsLineString, QgsSpatialIndex, QgsPolygon, QgsRectangle, QgsMultiLineString)
